...
const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 4, TPRI_MINTASK + 1, TPRI_MINTASK + 2, TPRI_MINTASK + 3, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 4, TPRI_MINTASK + 1, TPRI_MINTASK + 2, TPRI_MINTASK + 3, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000001, 0x00000001, 0x00000001, 0x00000001, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( TaskMain ), TASKNAME( TaskSensor ), TASKNAME( TaskActuator ), TASKNAME( TaskLogger ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_TaskMain, (__STK_UNIT)_stack_TaskSensor, (__STK_UNIT)_stack_TaskActuator, (__STK_UNIT)_stack_TaskLogger, };
